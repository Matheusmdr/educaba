  ...
  return (
    <MenuContent
      ...
      <MenuItem className="rounded-xl">
        <ListChecks className="text-primary" width={16} />
        <Text className="font-poppins-normal text-primary">Adicionar Registro</Text>
      </MenuItem>
      <MenuItem className="rounded-xl">
        <Pen className="text-primary" width={16} />
        <Text className="font-poppins-normal text-primary">Editar Programa</Text>
      </MenuItem>
      <MenuItem className="rounded-xl">
        <Trash className="text-destructive" width={16} />
        <Text className="font-poppins-normal text-destructive">Excluir Programa</Text>
      </MenuItem>
    </MenuContent>
  );
}
