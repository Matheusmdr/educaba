...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "native:text-xl font-poppins-semibold text-lg leading-none tracking-tight text-foreground",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("native:text-base font-poppins-normal text-sm text-muted-foreground", className)}
    {...props}
  />
));
